...
public class LITEmotiCollectShootingStarsWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITEmotiCollectShootingStarsWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITEmotiCollectShootingStarsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITEmotiCollectShootingStarsWLAIW/InitOutcome.xml").getDocumentElement();
